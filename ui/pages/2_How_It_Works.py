...
<div class="detail-card">
    ...
    <div class="detail-content">
        ...
        • <strong>LLaMA 3.1 (8B) HF</strong>: General-purpose text model via HuggingFace Cerebras provider<br>
...
<div class="pro-tip">
    ...
    <div class="pro-tip-content">
        ...
        <strong>For General Tasks:</strong> Use LLaMA 3.1 (HuggingFace) for general-purpose text generation, reasoning, and instruction-following.<br><br>
