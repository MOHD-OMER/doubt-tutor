...
<div class="detail-card">
    ...
    <div class="detail-content">
        ...
        • <strong>Phi-3 Mini (4K Instruct)</strong>: Efficient reasoning and instruction-following via HuggingFace<br>
...
<div class="pro-tip">
    ...
    <div class="pro-tip-content">
        ...
        <strong>For Reasoning Tasks:</strong> Use Phi-3 Mini (HuggingFace) for step-by-step explanations, instruction-following, and general text generation.<br><br>
...
st.markdown("<br><br>", unsafe_allow_html=True)# ui/pages/3_Models.py
import streamlit as st
from pathlib import Path
